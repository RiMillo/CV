...
\cvevent{2021 -}%
        ...
        {\href{https://sciences2024.polytechnique.fr/}{\textsc{Sciences}\textsuperscript{2024}}, la fisica degli sport. Tiro con l'arco: ottimizzazione della performance}%
...
\cvevent{2017 - 2020}%
        ...
        {\href{https://tel.archives-ouvertes.fr/tel-03080530}{Schemi \emph{Compatible Discrete Operator} per le equazioni non-stazionarie di Navier--Stoker per un fluido incompressibile}. Advisor: Ern Alexandre (ENPC, INRIA) e Bonelle J\'er\^ome (EDF R\&D)}%
        {Articolo \emph{peer-reviewed}: \href{https://www.degruyter.com/document/doi/10.1515/cmam-2021-0089/html}{\emph{Milani}, Bonelle, Ern; \emph{Artificial compressibility methods for the incompressible Navier--Stokes equations using lowest-order face-based schemes on polytopal meshes}, 2021, CMAM, 22(1), 133--154}}%
...
\cvevent{09/'16-02/'17}%
        ...
        {EDF R\&D, Chatou}%
        {\href{https://www.politesi.polimi.it/handle/10589/133692}{Sviluppo e analisi numerica di un metodo HHO per i problemi di diffusione anisotropa}}%
...
&       MATLAB/Scilab, Git/SVN, \texttt{python}, \href{https://www.code-saturne.org/cms/}{\cs{}},\\[3pt]
